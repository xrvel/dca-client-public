		...
		<tbody>
			...
			<tr valign="top">
				...
				<td>
					...
					<div>
						<a href="{{ route('binance.proxy', $dcakey->id) }}" class="btn btn-sm btn-secondary" target="_blank">See Proxy File</a>
					</div>
					@endif
				</td>
				...
				<td>
					...
					<input type="button" value="Test Connection" class="btn btn-sm btn-info" onclick="my_key_check_connection('{{ $dcakey->id }}')">
