						...
						<td>
							<div>
								@if ($dcahistory->dca_schedule)
									Schedule : <a
										href="{{ route('dcaschedules.edit', $dcahistory->schedule_id) }}">{{ $dcahistory->dca_schedule->label }}</a><br />
								@endif
							...
							@if ($dcahistory->dca_key)
								<div>
									Exchange key : <a
										href="{{ route('dcakeys.edit', $dcahistory->key_id) }}">{{ $dcahistory->dca_key->label }}</a><br />
